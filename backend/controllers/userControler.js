...
export const getUserProfile = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({ message: "Internal server error while getting user profile", error: error.message });
    }
}
...
export const followUnfollowUser = async (req, res) => {
    try {
        ...
        res.status(500).json({ message: "Internal server error while following/unfollowing user", error: error.message });
    }
}
...
export const updateUser = async (req, res) => {
    ...
    try {
        ...
        if (currentPassword && newPassword) {
            ...
            //after saving updated user, remove password from the user object
            user.password = null;
